...
function DefaultNavbarMobile({ routes, open, user, handleLogout }) {
    ...
    <Collapse in={Boolean(open)} timeout="auto" unmountOnExit>
      <MKBox width="calc(100% + 1.625rem)" my={2} ml={-2}>
        ...
        <MKBox mt={2} px={2}>
          {user ? (
            <>
              <MKTypography variant="button" color="success" fontWeight="medium" mb={1}>
                Hello, {user.name}
              </MKTypography>
              <MKBox mt={1}>
                <MKBox
...
DefaultNavbarMobile.propTypes = {
  ...
  user: PropTypes.object, // new
  handleLogout: PropTypes.func, // new
};
